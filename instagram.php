...
die();
       ...
       $num = count($stories);
       if( $num == "0" ){
       	echo '<div class="alert alert-info alert-atas" ><strong><b>
       	In the last 24 hours, this user has not shared a story or a private account...
       	</b> </strong> </div><br><br>';
       }else{
       	echo '  <div class="alert alert-success alert-bawah" ><strong><b>Username :</b> <a href="https://instagram.com/'.$username.'" class="card-title">@'.$username.'</a><br> Storys : <b>'.$num.'</b></strong> </div><br><br>';
        ...
        foreach ($_story as $story) {
            ...
            if (empty($matches)) {
                ...
                echo '<img class="gambar" src="'.$story.'" width="300" height="300" alt="foto profil"/><br><br>';
echo '<a href="'.$story.'&dl=1" style="padding:5px;width:100px;text-align:center" class="btn btn-success" type="submit" name="ambil">Download</a><br><hr class="new1"><br><br><br>';
